...
import com.nidhin.marketzen.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService{
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try {
            ...
            coin.setPriceChange24h(marketData.get("price_change2_24h").get("usd").asDouble());
    ...
    public Coin findById(String coinId) throws Exception {
        Optional<Coin> optionalCoin=coinRepository.findById(Integer.valueOf(coinId));
    ...
    public String GetTreadingCoins() throws Exception {
        String url="https://api.coingecko.com/api/v3/search/treading";  //4:37:19
        RestTemplate restTemplate =new RestTemplate();
        try {
            HttpHeaders headers = new HttpHeaders();
            HttpEntity<String> entity=new HttpEntity<String>("parameters", headers);
